...
[![License](https://img.shields.io/badge/LICENSE-GPL3-2f3542?style=for-the-badge&logo=unlicense&logoColor=white)](https://github.com/tabletseeker/mobian/blob/master/LICENSE) [![Stars](https://img.shields.io/github/stars/tabletseeker/mobian?style=for-the-badge&color=ffaa00&logo=macys&logoColor=white)](https://github.com/tabletseeker/mobian/stargazers) [![Issues](https://img.shields.io/github/issues/tabletseeker/mobian?style=for-the-badge&color=26b861&logo=helpdesk&logoColor=white)](https://github.com/tabletseeker/mobian/issues) [![CI Status](https://img.shields.io/badge/CI-PASSED-26b861?style=for-the-badge&logo=bilibili&logoColor=white)](https://github.com/tabletseeker/mobian/actions) [![Discussions](https://img.shields.io/badge/DISCUSSIONS-ACTIVE-1e90ff?style=for-the-badge&logo=livechat&logoColor=white)](https://github.com/tabletseeker/mobian/discussions) [![Release](https://img.shields.io/badge/RELEASE-V2026.04-ff4757?style=for-the-badge&logo=github&logoColor=white)](https://github.com/tabletseeker/mobian/releases)
...
- [x] Preview
### General UI
* Mobian uses a phosh environment by default which if so desired can be replaced with a simple change in the package lists. For example, other comparable mobile environments are Lomiri and Plasma Mobile.
...
4. Encryption
   ...
   Note: Both Automatic and Manual partitioning allow for the selection of full disk encryption with LUKS.
